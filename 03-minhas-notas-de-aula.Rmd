...
Todos os **VIDEOS** disponibilizados pela professora estão no [capítulo 13](#cap-outros-materiais) deste livro ( Outros materias ). \@ref(cap-outros-materiais)
...
knitr::include_graphics("figuras/Aula2-1-posicao-anatômica-e-termos-regionais.png")
```
...
knitr::include_graphics("figuras/Aula2-2 - Planos de Seccao.png")
```
...
[1]:  **Introdução à Anatomia Humana**. Anatomia Humana. Notas de aula (08/08/2022), Faculdade Três Marias, Paraíba 2022.
...
[1]:  **Introdução à Anatomia Humana**. Anatomia Humana. Notas de aula (15/08/2022), Faculdade Três Marias, Paraíba 2022.

[2]:  **Osteologia (1/2)**. Anatomia Humana. Notas de aula (15/08/2022), Faculdade Três Marias, Paraíba 2022.
...
knitr::include_graphics("figuras/Aula4-1-Ossos-do-braco.jpeg")
```
...
knitr::include_graphics("figuras/Aula4-2-ossos-da-mao.jpeg")
```

### Membros Inferiores

```{r echo=FALSE, fig.show="hold", out.width="50%", fig.align = "center", fig.cap="Ossos do Pé"}
knitr::include_graphics("figuras/Aula4-3a-ossos-do-pe.jpeg")
knitr::include_graphics("figuras/Aula4-3b-ossos-do-pe.jpg")
```
...
[1]:  **Osteologia (2/2)**. Anatomia Humana. Notas de aula (22/08/2022), Faculdade Três Marias, Paraíba 2022.
...
knitr::include_graphics("figuras/Aula5-1-ossos-do-aparelho-auditivo.png")
knitr::include_graphics("figuras/Aula5-2-ossos-do-aparelho-audivo.jpeg")
```
...
knitr::include_graphics("figuras/Aula5-3-musculos-da-face.jpeg")
```
...
knitr::include_graphics("figuras/Aula5-5-musculos-do-pescoco.jpeg")
```
...
knitr::include_graphics("figuras/Aula5-4-musculos-do-ombro-e-braco.png")
knitr::include_graphics("figuras/Aula5-6-musculos-do-antebraco.png")
```
...
knitr::include_graphics("figuras/Aula5-7-musculos-do-abdome.jpg")
```
...
[1]:  **Sistema Articulatório**. Anatomia Humana. Notas de aula (29/08/2022), Faculdade Três Marias, Paraíba 2022.

[2]:  **Sistema Muscular**. Anatomia Humana. Notas de aula (29/08/2022), Faculdade Três Marias, Paraíba 2022.
...
knitr::include_graphics("figuras/Aula6-1-neuronio.jpg")
```
...
knitr::include_graphics("figuras/Aula6-2-medula-espinhal.jpg")
```
...
knitr::include_graphics("figuras/Aula7-1-o-coracao.jpg")
```
...
knitr::include_graphics("figuras/Aula7-2-bombeamento-coracao.png")
```
...
knitr::include_graphics("figuras/Aula8-1-esquema-do-sistema-respiratorio.jpg")
```
...
knitr::include_graphics("figuras/Aula8-2-laringe.jpg")
```
...
knitr::include_graphics("figuras/Aula8-3-caixa-toracica-enfase-traqueia.jpg")
```
